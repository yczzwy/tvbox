...
# 候选JS/PY非采集源（从liu673cn/box仓库）
CANDIDATE_JSPY = [
    {"name": "🌕┃豆瓣┃热播", "api": "csp_DouDou", "ext": ""},
    {"name": "🔥┃设置Token", "api": "csp_KungFu404", "ext": "http://127.0.0.1:9978/file/tvfan/token.txt", "jar": "./libs/jar/Token.jar"},
    {"name": "🎰┃蜂蜜┃商店", "api": "csp_Market", "ext": "./libs/market.json", "jar": "./libs/jar/app.jar"},
    {"name": "📺︎┃电视┃点播", "api": "./libs/tv/zb.min.js", "ext": "./libs/tv/zb.json"},
    {"name": "🐯┃虎牙┃直播", "api": "./libs/js/drpy2.min.js", "ext": "./libs/js/虎牙直播.js"},
    {"name": "🐟┃斗鱼┃直播", "api": "./libs/js/drpy2.min.js", "ext": "./libs/js/斗鱼直播.js"},
    {"name": "👽玩偶哥哥┃4K弹幕", "api": "csp_WoGG", "ext": ""},
    {"name": "🚀┃叨观┃新片", "api": "csp_YGP", "ext": ""},
    {"name": "📽️┃一直播┃LIVE", "api": "csp_Alllive", "ext": ""},
    {"name": "🦋┃米盘┃搜搜", "api": "csp_MIPanSo", "ext": ""},
    {"name": "🍄┃抠抠┃搜搜", "api": "csp_KkSs", "ext": ""},
    {"name": "🌟┃Lib┃秒播", "api": "csp_Libvio", "ext": ""},
    {"name": "💮┃文采┃秒播", "api": "csp_Jpys", "ext": ""},
    {"name": "🍓┃糯米┃秒播", "api": "csp_Nmyswv", "ext": ""},
    {"name": "🍎┃苹果┃IJK", "api": "csp_LiteApple", "ext": ""},
    {"name": "👀┃萌米┃多线", "api": "csp_AppTT", "ext": ""},
    {"name": "👓┃欢视┃多线", "api": "csp_AppTT", "ext": ""},
    {"name": "🎃┃南瓜┃多线", "api": "csp_NanGua", "ext": ""},
    {"name": "📺┃热播┃多线", "api": "csp_AppTT", "ext": ""},
    {"name": "👻┃可可┃多线", "api": "csp_Kekys", "ext": ""},
    {"name": "🍊┃在线┃外剧", "api": "csp_Zxzj", "ext": "https://www.zxzjhd.com/"},
    {"name": "⏮️┃低端┃外剧", "api": "csp_Ddrk", "ext": ""},
    {"name": "🐭┃贱贱┃P2P", "api": "./lib/drpy2.min.js", "ext": "./lib/jp.js"},
    {"name": "📔┃厂长┃不卡", "api": "csp_NewCz", "ext": "https://www.czzy77.com/"},
    {"name": "☀┃原创┃不卡", "api": "csp_YCyz", "ext": ""},
    {"name": "🍄┃Btt┃秒播", "api": "csp_Bttwoo", "ext": ""},
    {"name": "🏝┃Aue┃无广", "api": "csp_Auete", "ext": "https://auete.pro/"},
    {"name": "🧲┃新6V┃磁力", "api": "csp_SixV", "ext": "https://www.xb6v.com/"},
    {"name": "💢┃耐看┃电影", "api": "csp_XBPQ", "ext": "./libs/hccx/nkvlog.json", "jar": "./libs/jar/HCCX.jar"},
    {"name": "💰️┃Free┃影院", "api": "csp_XBPQ", "ext": "./libs/hccx/Free影视.json", "jar": "./libs/jar/HCCX.jar"},
    {"name": "🌎┃美剧┃影视", "api": "csp_KmeiJu", "ext": "", "jar": "./libs/jar/Panda.jar"},
    {"name": "🏳️┃素白┃影视", "api": "csp_SuBaiBai", "ext": "", "jar": "./libs/jar/Panda.jar"},
    {"name": "💕┃爱看┃影视", "api": "csp_Ikan", "ext": "", "jar": "./libs/jar/Panda.jar"},
    {"name": "🐕┃疯狗┃影视", "api": "csp_FengGo", "ext": "", "jar": "./libs/jar/Panda.jar"},
    {"name": "⭕┃剧圈┃影视", "api": "csp_Juqq", "ext": "", "jar": "./libs/jar/Panda.jar"},
    {"name": "💌┃至臻┃影视", "api": "csp_Netfixtv", "ext": "", "jar": "./libs/jar/Panda.jar"},
    {"name": "🎼┃Vid┃影视", "api": "csp_Vidhub2", "ext": "", "jar": "./libs/jar/Panda.jar"},
    {"name": "🕵┃忍者┃影视", "api": "csp_AppRZ", "ext": "http://rzys.xyz/", "jar": "./libs/jar/Panda.jar"},
    {"name": "👌┃Fre┃影视", "api": "csp_FreeOK", "ext": "", "jar": "./libs/jar/Panda.jar"},
    {"name": "🦙┃毛驴┃影视", "api": "csp_MaoLv", "ext": "", "jar": "./libs/jar/Panda.jar"},
    {"name": "☁️┃云播┃影视", "api": "./libs/js/drpy2.min.js", "ext": "./lib/TVB云播.js", "jar": "./libs/jar/Panda.jar"},
    {"name": "🐯┃虎虎┃影视", "api": "csp_XBPQ", "ext": "./lib/虎虎.json", "jar": "./libs/jar/Panda.jar"},
    {"name": "🏰┃圣城┃影视", "api": "csp_SC1080", "ext": "", "jar": "./libs/jar/Panda.jar"},
    {"name": "💢┃兄弟┃影视", "api": "csp_XBPQ", "ext": "./libs/hccx/兄弟.json", "jar": "./libs/jar/HCCX.jar"},
    {"name": "🖍︎┃蜡笔┃云盘", "api": "csp_Duopan", "ext": "https://duopan.fun/", "jar": "./libs/jar/Panda.jar"},
    {"name": "🎬┃荐片┃影视", "api": "csp_Jianpian", "ext": "http://api2.rinhome.com", "jar": "./libs/jar/Panda.jar"},
    {"name": "💋┃爱看┃Bot", "api": "csp_Ikanbot", "ext": "", "jar": "./libs/jar/XYQH.jar"},
    {"name": "🏵┃韩剧┃高清", "api": "csp_XBPQ", "ext": "./libs/hccx/hanjulao.json", "jar": "./libs/jar/HCCX.jar"},
    {"name": "🍁┃久久┃影视", "api": "csp_XYQHiker", "ext": "./libs/xyq/jojo.json", "jar": "./libs/jar/XYQH.jar"},
    {"name": "🎦┃VS┃影院", "api": "csp_XYQHiker", "ext": "./libs/xyq/VS影院.json", "jar": "./libs/jar/XYQH.jar"},
]
